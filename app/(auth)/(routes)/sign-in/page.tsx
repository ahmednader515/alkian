...
export default function SignInPage() {
  ...
  return (
    <div className="flex min-h-screen bg-background overflow-y-auto">
      ...
      {/* Right Side - Image */}
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-[#052b4a]/10 to-[#052b4a]/5 relative overflow-hidden">
        <div className="absolute inset-0 bg-[#052b4a]/5"></div>
          ...
          <div className="text-center space-y-6 p-8">
            <div className="relative w-64 h-64 mx-auto">
              <Image
                ...
                alt="Teacher"
                fill
                className="object-cover rounded-full border-4 border-[#052b4a]/20 shadow-2xl"
                unoptimized
              />
            </div>
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-[#052b4a]">
                مرحباً بك مرة أخرى
              </h3>
