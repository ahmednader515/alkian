...
export default function SignUpPage() {
  ...
  return (
    <RecaptchaGate storageKey="signup_recaptcha_verified">
      <div className="flex min-h-screen bg-background overflow-y-auto overflow-x-hidden">
      ...
      {/* Right Side - Image */}
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-[#052c4b]/10 to-[#052c4b]/5 relative overflow-hidden">
        <div className="absolute inset-0 bg-[#052c4b]/5"></div>
          ...
          <div className="text-center space-y-6 p-8">
            <div className="relative w-64 h-64 mx-auto">
              <Image
                ...
                alt="Teacher"
                fill
                className="object-cover rounded-full border-4 border-[#052c4b]/20 shadow-2xl"
                unoptimized
              />
            </div>
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-[#052c4b]">
                مرحباً بك في مركز الكيان للتأهيل و التدريب
              </h3>
      ...
      <div className="flex-1 flex items-start justify-center p-8 min-w-0">
        <div className="w-full max-w-md space-y-6 py-8 mt-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full h-10 bg-[#052c4b] hover:bg-[#052c4b]/90 text-white"
